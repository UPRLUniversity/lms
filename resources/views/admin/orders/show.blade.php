...
<x-app-layout :title="'Order '.$order->shortReference()">
    <div class="mx-auto max-w-3xl space-y-6">
        <nav class="text-sm">
            <a href="{{ route('admin.orders.index') }}" class="inline-flex items-center gap-1.5 text-ink/60 hover:text-ink focus-ring rounded">
        ...
        <x-ui.card>
            ...
            @if (filled($order->billing))
                <div class="mt-4 border-t border-line pt-4">
                    <p class="text-xs font-medium uppercase tracking-wide text-ink/50">Billing details given</p>
